...
const OfficerEditInvoice = () => {
  ...
  const handleResubmit = async () => {
    ...
    const payload = {
      invoiceData: getValues('invoiceData'),
      notes: notes.trim() || 'Edited by Stage 1 Officer',
    }
    ...
    <>
      ...
      <div className="oei-page">
        ...
        <div style={{ marginBottom: '1rem' }}>
          <button
            type="button"
            onClick={() => navigate(`/officer/invoices/${originalInvoiceId}`)}
            style={{
              display: 'flex',
              alignItems: 'center',
              gap: 6,
...
export default OfficerEditInvoice
