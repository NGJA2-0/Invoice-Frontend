...
// Reusable "View History" control for Stage 2.
// Fetches /stage2/invoices/:originalInvoiceId/history, builds a dropdown
...
const Stage2InvoiceHistoryDropdown = ({ originalInvoiceId, onSelect, activeRecordId }) => {
  ...
  const fetchHistory = async () => {
    ...
    setError(null)
    try {
      const res = await officerApi.getStage2History(originalInvoiceId)
      console.log('[stage2 history] raw response:', res)
...
export default Stage2InvoiceHistoryDropdown