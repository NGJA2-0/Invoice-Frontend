...
const Stage2EditInvoice = () => {
  ...
  useEffect(() => {
    ...
    officerApi
      .getStage2DocumentById(originalInvoiceId)
  ...
  const handleResubmit = async () => {
    ...
    const payload = {
      invoiceData: getValues('invoiceData'),
      notes: notes.trim() || 'Edited by Stage 2 Officer',
    }

    setSubmitting(true)
    try {
      await officerApi.editStage2Invoice(targetId, user.id, payload)
      pushToast({
    ...
    <>
      ...
      <div className="oei-page">
        ...
        <div style={{ marginBottom: '1rem' }}>
          <button
            type="button"
            onClick={() => navigate(`/officer2/invoices/${originalInvoiceId}`)}
            style={{
              display: 'flex',
              alignItems: 'center',
              gap: 6,
...
export default Stage2EditInvoice