...
// Reusable "View History" control for Stage 3.
// Fetches /stage3/invoices/:originalInvoiceId/history, builds a dropdown
...
const Stage3InvoiceHistoryDropdown = ({ originalInvoiceId, onSelect, activeRecordId }) => {
  ...
  const fetchHistory = async () => {
    ...
    setError(null)
    try {
      const res = await officerApi.getStage3History(originalInvoiceId)
      console.log('[stage3 history] raw response:', res)
...
export default Stage3InvoiceHistoryDropdown